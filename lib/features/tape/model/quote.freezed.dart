...
abstract class $QuoteCopyWith<$Res> {
  ...
  @useResult
  $Res call({String author, String text, String category});
}
...
class _$QuoteImpl implements _Quote {
  const _$QuoteImpl(
      {required this.author, required this.text, required this.category});
  ...
  @override
  String toString() {
    return 'Quote(author: $author, text: $text, category: $category)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, author, text, category);
...
abstract class _Quote implements Quote {
  const factory _Quote(
      ...
      required final String category}) = _$QuoteImpl;
